...
function createScoreCloudantDB() {
  ...
  printf "\nCLOUDANT_DES_SCORES=$CLOUDANT_DES_SCORES"  >> $ENV_CLOUDANT_FILE
  printf "\nCLOUDANT_DES_SCORES=$CLOUDANT_DES_SCORES"  >> $ENV_SERVER_FILE
  printf "\nCLOUDANT_IDX_SCORES=$CLOUDANT_IDX_SCORES"  >> $ENV_CLOUDANT_FILE
  printf "\nCLOUDANT_IDX_SCORES=$CLOUDANT_IDX_SCORES"  >> $ENV_SERVER_FILE
  printf "\nCLOUDANT_DES_HIGHSCORE=$CLOUDANT_DES_HIGHSCORE"  >> $ENV_CLOUDANT_FILE
  printf "\nCLOUDANT_DES_HIGHSCORE=$CLOUDANT_DES_HIGHSCORE"  >> $ENV_SERVER_FILE
  printf "\nCLOUDANT_IDX_HIGHSCORE=$CLOUDANT_IDX_HIGHSCORE"  >> $ENV_CLOUDANT_FILE
  printf "\nCLOUDANT_IDX_HIGHSCORE=$CLOUDANT_IDX_HIGHSCORE"  >> $ENV_SERVER_FILE
